...
//   getData(page)
  ...
  var select = document.getElementById("select");
      ...
      let countfort = 0;
      function helloDesign(DataArray) {
        console.log("arrarasdfsdf", DataArray);
        if (countfort % 2 == 0) {
          countfort++;
          let brand = [];
          DataArray.forEach((ele) => {
            if (ele.brand == "HELLO DESIGN") {
      ...
      let countlevis = 0;
      function fableStreet(DataArray) {
        console.log(DataArray);
        if (countlevis % 2 == 0) {
          countlevis++;
          let brand = [];
          DataArray.forEach((ele) => {
            if (ele.brand == "Fable Street") {
              console.log(ele.brand);
              brand.push(ele);
            }
          });
      ...
      let countperform = 0;
      function rituKumar(DataArray) {
        console.log(DataArray);
        if (countperform % 2 == 0) {
          countperform++;
          let brand = [];
          DataArray.forEach((ele) => {
            if (ele.brand == "RITU KUMAR") {
              console.log(ele.brand);
              brand.push(ele);
            }
          });
      ...
      let countTerrain = 0;
      function berrylush(DataArray) {
        console.log(DataArray);
        if (countTerrain % 2 == 0) {
          countTerrain++;
          let brand = [];
          DataArray.forEach((ele) => {
            if (ele.brand == "Berrylush") {
              console.log(ele.brand);
              brand.push(ele);
            }
          });
